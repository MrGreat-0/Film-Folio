...
const MovieDetails = () => {
  ...
  return info ? (
    <div className="movie-detatil-wrapper w-full min-h-[91vh] pb-10 relative">
      <div
        style={{
      ...
      >
        <div className="movie-detail-left w-full lg:w-[35%] h-full flex lg:items-center justify-center lg:justify-end my-10 lg:my-0 relative">
          <div className="movie-poster w-[75%] h-[80%] md:w-[65%] md:h-[80%] lg:w-[90%] lg:h-[90%] xl:w-[70%] xl:h-[85%] image-container inline-block rounded-lg overflow-hidden">
            <img
        ...
        <div className="movie-detail-right w-full lg:w-[55%] h-full flex flex-col justify-center lg:pl-12 mb-10 lg:my-10 relative">
          <h1 className="movie-name font-semibold text-center lg:text-start text-3xl xs:text-4xl md:text-5xl relative">
            {info.detail.name ||
              info.detail.title ||
              info.detail.original_name ||
              info.detail.original_title ||
          ...
          <h3 className="movie-tagline text-center lg:text-start text-zinc-400 text-base sm:text-lg lg:text-xl mt-2 italic">
            {info.detail.tagline}
          </h3>
          <div className="movie-genres flex flex-wrap justify-center lg:justify-start gap-6 my-6 text-zinc-100 text-sm relative">
          ...
          <div className="movie-metadata relative">
            <div className="metadata-wrapper font-semibold lg:flex lg:gap-8 border-b-[0.1px] border-b-zinc-600 pb-4 relative">
              ...
              <div className="metadata-info flex gap-2 relative">
                ...
                <span className="text-zinc-400">
                  {info.detail.release_date || "No Information"}
                </span>
              </div>
            </div>
      ...
      <div className="other-stuff w-full min-h-screen text-lg px-2 relative">
        <div className="movie-metadata w-full h-full relative flex flex-col lg:flex-row">
          <div className="movie-credits-metadata w-full h-full lg:w-1/2 my-6 flex flex-col gap-8 items-center relative">
            <div className="movie-crew-metadata">
              {
            ...
            <div className="movie-production-company w-fit flex flex-col gap-3 items-center bg-zinc-100 text-zinc-800 rounded-lg overflow-hidden relative">
          ...
          <div className="movie-platform w-full h-full lg:w-1/2 flex flex-col items-center py-6 relative">
            <div className="w-fit flex flex-col gap-6 p-6 shadow-xl shadow-zinc-400">
              <div className="movie-available-platform">
              ...
              <div className="movie-buy-platform">
              ...
              <div className="movie-rent-platform">
        ...
        <div className="movie-slider w-full flex flex-col items-center py-10 gap-10 relative">
          <div className="movie-slide-wrapper w-[90%]">
        ...
        <div className="movie-cast w-full relative">
      ...
      <div className="movie-related-stuff w-full min-h-screen relative">
        <div className="movie-recommendation w-[95%] h-full mx-auto">
          <ContentTitle title="Recommendations" toggleSwitchCount={0} />

          <div className="recommended-movie-wrapper w-full h-full relative">
        ...
        <div className="movie-similar w-[95%] h-full mx-auto">
          <ContentTitle title="Similar Movies" toggleSwitchCount={0} />

          <div className="similar-movie-wrapper w-full h-full relative">
            {info.similar?.length ? (
              <Content cardData={info.similar.slice(0, 14)} title="movie" />
            ) : (
              <span className="text-zinc-400">No Information</span>
            )}
          </div>
